...
const wishList = [
  ...
  {
    text: "Cầu chúc cho mọi nguyện ước của em sẽ trở thành hiện thực.",
    img: "./assets/2.jpg",
  },
  {
    text: "Trăng tròn ấm áp, chúc chúng ta mãi bền chặt em nhé.",
    img: "./assets/3.jpg",
  },
  {
    text: "Chúc cho tình yêu của chúng ta mãi rạng rỡ và bền chặt theo năm tháng.",
    img: "./assets/1.jpg",
  },
  {
  ...
  {
    text: "Trăng chỉ sáng nhất vào ngày rằm, còn cuộc đời anh chỉ thực sự tươi sáng khi có em ở bên..",
    img: "./assets/3.jpg",
  },
  {
    text: "Sức khỏe dồi dào, tâm an yên, miệng luôn mỉm cười rạng rỡ em nhé.",
    img: "./assets/1.jpg",
  },
];
